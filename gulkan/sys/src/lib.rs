...
impl ::std::fmt::Debug for GulkanBufferClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanBufferClass @ {:p}", self))
...
impl ::std::fmt::Debug for GulkanClientClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanClientClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanCmdBufferClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanCmdBufferClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanDescriptorPoolClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanDescriptorPoolClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanDeviceClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanDeviceClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanFrameBufferClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanFrameBufferClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanInstanceClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanInstanceClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanQueueClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanQueueClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanRenderPassClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanRenderPassClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanRendererClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanRendererClass @ {:p}", self))
...
impl ::std::fmt::Debug for GulkanSwapchainClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanSwapchainClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanSwapchainRendererClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanSwapchainRendererClass @ {:p}", self))
         .field("parent", &self.parent)
...
impl ::std::fmt::Debug for GulkanTextureClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanTextureClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanUniformBufferClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanUniformBufferClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanVertexBufferClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanVertexBufferClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanBuffer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanBuffer @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanClient {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanClient @ {:p}", self))
...
impl ::std::fmt::Debug for GulkanCmdBuffer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanCmdBuffer @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanDescriptorPool {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanDescriptorPool @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanDevice {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanDevice @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanFrameBuffer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanFrameBuffer @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanInstance {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanInstance @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanQueue {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanQueue @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanRenderPass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanRenderPass @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanRenderer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanRenderer @ {:p}", self))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanSwapchain {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanSwapchain @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanSwapchainRenderer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanSwapchainRenderer @ {:p}", self))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanTexture {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanTexture @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanUniformBuffer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanUniformBuffer @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GulkanVertexBuffer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GulkanVertexBuffer @ {:p}", self))
         .finish()
    }
}

#[link(name = "gulkan-0.15")]
extern "C" {
    ...
    pub fn gulkan_client_new_from_extensions(instance_ext_list: *mut glib::GSList, device_ext_list: *mut glib::GSList) -> *mut GulkanClient;
    ...
    pub fn gulkan_client_get_physical_device_handle(self_: *mut GulkanClient) -> vulkan::VkPhysicalDevice;
    ...
    pub fn gulkan_descriptor_pool_new(device: vulkan::VkDevice, bindings: *const vulkan::VkDescriptorSetLayoutBinding, binding_count: u32, pool_sizes: *const vulkan::VkDescriptorPoolSize, pool_size_count: u32, set_count: u32) -> *mut GulkanDescriptorPool;
    pub fn gulkan_descriptor_pool_new_from_layout(device: vulkan::VkDevice, layout: vulkan::VkDescriptorSetLayout, pool_sizes: *const vulkan::VkDescriptorPoolSize, pool_size_count: u32, set_count: u32) -> *mut GulkanDescriptorPool;
    pub fn gulkan_descriptor_pool_allocate_sets(self_: *mut GulkanDescriptorPool, count: u32, sets: *mut vulkan::VkDescriptorSet) -> gboolean;
    ...
    pub fn gulkan_frame_buffer_new(device: *mut GulkanDevice, render_pass: *mut GulkanRenderPass, extent: vulkan::VkExtent2D, sample_count: vulkan::VkSampleCountFlagBits, color_format: vulkan::VkFormat, use_depth: gboolean) -> *mut GulkanFrameBuffer;
    pub fn gulkan_frame_buffer_new_from_image(device: *mut GulkanDevice, render_pass: *mut GulkanRenderPass, color_image: vulkan::VkImage, extent: vulkan::VkExtent2D, color_format: vulkan::VkFormat) -> *mut GulkanFrameBuffer;
    pub fn gulkan_frame_buffer_new_from_image_with_depth(device: *mut GulkanDevice, render_pass: *mut GulkanRenderPass, color_image: vulkan::VkImage, extent: vulkan::VkExtent2D, sample_count: vulkan::VkSampleCountFlagBits, color_format: vulkan::VkFormat) -> *mut GulkanFrameBuffer;
    ...
    pub fn gulkan_renderer_create_shader_module(self_: *mut GulkanRenderer, resource_name: *const c_char, module: *mut vulkan::VkShaderModule) -> gboolean;
    ...
    pub fn gulkan_swapchain_new(client: *mut GulkanClient, surface: vulkan::VkSurfaceKHR, present_mode: vulkan::VkPresentModeKHR, format: vulkan::VkFormat, colorspace: vulkan::VkColorSpaceKHR) -> *mut GulkanSwapchain;
    ...
    pub fn gulkan_swapchain_reset_surface(self_: *mut GulkanSwapchain, surface: vulkan::VkSurfaceKHR) -> gboolean;

    //=========================================================================
    // GulkanSwapchainRenderer
    //=========================================================================
    pub fn gulkan_swapchain_renderer_get_type() -> GType;
    pub fn gulkan_swapchain_renderer_begin_render_pass(self_: *mut GulkanSwapchainRenderer, clear_color: vulkan::VkClearColorValue, index: u32);
    pub fn gulkan_swapchain_renderer_get_cmd_buffer(self_: *mut GulkanSwapchainRenderer, index: u32) -> vulkan::VkCommandBuffer;
    pub fn gulkan_swapchain_renderer_get_frame_buffer(self_: *mut GulkanSwapchainRenderer, index: u32) -> *mut GulkanFrameBuffer;
    pub fn gulkan_swapchain_renderer_get_render_pass(self_: *mut GulkanSwapchainRenderer) -> *mut GulkanRenderPass;
    pub fn gulkan_swapchain_renderer_get_render_pass_handle(self_: *mut GulkanSwapchainRenderer) -> vulkan::VkRenderPass;
    pub fn gulkan_swapchain_renderer_get_swapchain_size(self_: *mut GulkanSwapchainRenderer) -> u32;
    pub fn gulkan_swapchain_renderer_init_draw_cmd_buffers(self_: *mut GulkanSwapchainRenderer) -> gboolean;
    pub fn gulkan_swapchain_renderer_initialize(self_: *mut GulkanSwapchainRenderer, surface: vulkan::VkSurfaceKHR, clear_color: vulkan::VkClearColorValue, pipeline_data: gconstpointer) -> gboolean;
    pub fn gulkan_swapchain_renderer_resize(self_: *mut GulkanSwapchainRenderer, surface: vulkan::VkSurfaceKHR) -> gboolean;

    //=========================================================================
    // GulkanTexture
    //=========================================================================
    pub fn gulkan_texture_get_type() -> GType;
    pub fn gulkan_texture_new(client: *mut GulkanClient, extent: vulkan::VkExtent2D, format: vulkan::VkFormat) -> *mut GulkanTexture;
    pub fn gulkan_texture_new_export_fd(client: *mut GulkanClient, extent: vulkan::VkExtent2D, format: vulkan::VkFormat, layout: vulkan::VkImageLayout, size: *mut size_t, fd: *mut c_int) -> *mut GulkanTexture;
    pub fn gulkan_texture_new_from_cairo_surface(client: *mut GulkanClient, surface: *mut cairo::cairo_surface_t, format: vulkan::VkFormat, layout: vulkan::VkImageLayout) -> *mut GulkanTexture;
    pub fn gulkan_texture_new_from_dmabuf(client: *mut GulkanClient, fd: c_int, extent: vulkan::VkExtent2D, format: vulkan::VkFormat) -> *mut GulkanTexture;
    pub fn gulkan_texture_new_from_pixbuf(client: *mut GulkanClient, pixbuf: *mut gdk_pixbuf::GdkPixbuf, format: vulkan::VkFormat, layout: vulkan::VkImageLayout, create_mipmaps: gboolean) -> *mut GulkanTexture;
    pub fn gulkan_texture_new_mip_levels(client: *mut GulkanClient, extent: vulkan::VkExtent2D, mip_levels: c_uint, format: vulkan::VkFormat) -> *mut GulkanTexture;
    ...
    pub fn gulkan_vertex_buffer_new_from_attribs(device: *mut GulkanDevice, positions: *const c_float, positions_size: size_t, colors: *const c_float, colors_size: size_t, normals: *const c_float, normals_size: size_t) -> *mut GulkanVertexBuffer;
    pub fn gulkan_vertex_buffer_alloc_array(self_: *mut GulkanVertexBuffer, device: *mut GulkanDevice) -> gboolean;
    pub fn gulkan_vertex_buffer_alloc_data(self_: *mut GulkanVertexBuffer, device: *mut GulkanDevice, data: *mut c_void, size: vulkan::VkDeviceSize) -> gboolean;
    pub fn gulkan_vertex_buffer_alloc_empty(self_: *mut GulkanVertexBuffer, device: *mut GulkanDevice, multiplier: u32) -> gboolean;
    pub fn gulkan_vertex_buffer_alloc_index_data(self_: *mut GulkanVertexBuffer, device: *mut GulkanDevice, data: *mut c_void, element_size: vulkan::VkDeviceSize, element_count: c_uint) -> gboolean;
