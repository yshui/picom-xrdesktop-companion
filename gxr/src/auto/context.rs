...
impl Context {
    ...
    //pub fn from_vulkan_extensions(type_: /*Ignored*/AppType, instance_ext_list: /*Unimplemented*/&[&Fundamental: Pointer], device_ext_list: /*Unimplemented*/&[&Fundamental: Pointer], app_name: &str, app_version: u32) -> Context {
    //    unsafe { TODO: call ffi:gxr_context_new_from_vulkan_extensions() }
    //}

    //#[doc(alias = "gxr_context_new_full")]
    //pub fn new_full(type_: /*Ignored*/AppType, api: /*Ignored*/Api, instance_ext_list: /*Unimplemented*/&[&Fundamental: Pointer], device_ext_list: /*Unimplemented*/&[&Fundamental: Pointer], app_name: &str, app_version: u32) -> Context {
    ...
    pub fn new_headless(app_name: &str, app_version: u32) -> Context {
        unsafe {
            from_glib_full(ffi::gxr_context_new_headless(app_name.to_glib_none().0, app_version))
        }
    }
...
pub trait ContextExt: 'static {
    ...
    //fn device_manager(&self) -> /*Unimplemented*/Option<Fundamental: Pointer>;
    ...
    fn load_action_manifest(&self, cache_name: &str, resource_path: &str, manifest_name: &str) -> bool;
    ...
    fn connect_action_set_update_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "binding-loaded-event")]
    fn connect_binding_loaded_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "bindings-update-event")]
    fn connect_bindings_update_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;
...
impl<O: IsA<Context>> ContextExt for O {
    ...
    fn begin_frame(&self) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_begin_frame(self.as_ref().to_glib_none().0))
        }
    }

    fn device_is_controller(&self, i: u32) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_device_is_controller(self.as_ref().to_glib_none().0, i))
        }
    }

    fn end_frame(&self) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_end_frame(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn device_model_name(&self, i: u32) -> Option<glib::GString> {
        unsafe {
            from_glib_full(ffi::gxr_context_get_device_model_name(self.as_ref().to_glib_none().0, i))
        }
    }
    ...
    fn model_normal_offset(&self) -> u32 {
        unsafe {
            ffi::gxr_context_get_model_normal_offset(self.as_ref().to_glib_none().0)
        }
    }

    fn model_uv_offset(&self) -> u32 {
        unsafe {
            ffi::gxr_context_get_model_uv_offset(self.as_ref().to_glib_none().0)
        }
    }

    fn model_vertex_stride(&self) -> u32 {
        unsafe {
            ffi::gxr_context_get_model_vertex_stride(self.as_ref().to_glib_none().0)
        }
    }

    fn view_count(&self) -> u32 {
        unsafe {
            ffi::gxr_context_get_view_count(self.as_ref().to_glib_none().0)
        }
    }

    fn is_another_scene_running(&self) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_is_another_scene_running(self.as_ref().to_glib_none().0))
        }
    }

    fn is_input_available(&self) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_is_input_available(self.as_ref().to_glib_none().0))
        }
    }

    fn is_tracked_device_connected(&self, i: u32) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_is_tracked_device_connected(self.as_ref().to_glib_none().0, i))
        }
    }

    fn load_action_manifest(&self, cache_name: &str, resource_path: &str, manifest_name: &str) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_load_action_manifest(self.as_ref().to_glib_none().0, cache_name.to_glib_none().0, resource_path.to_glib_none().0, manifest_name.to_glib_none().0))
        }
    }
    ...
    fn submit_framebuffers(&self) -> bool {
        unsafe {
            from_glib(ffi::gxr_context_submit_framebuffers(self.as_ref().to_glib_none().0))
        }
    }

    fn connect_action_set_update_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn action_set_update_event_trampoline<P: IsA<Context>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::GxrContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Context::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"action-set-update-event\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(action_set_update_event_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_binding_loaded_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn binding_loaded_event_trampoline<P: IsA<Context>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::GxrContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Context::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"binding-loaded-event\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(binding_loaded_event_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_bindings_update_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn bindings_update_event_trampoline<P: IsA<Context>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::GxrContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Context::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"bindings-update-event\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(bindings_update_event_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_keyboard_close_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn keyboard_close_event_trampoline<P: IsA<Context>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::GxrContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Context::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
