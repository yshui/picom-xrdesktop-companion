...
pub struct GxrActionClass {
    ...
    pub trigger_haptic: Option<unsafe extern "C" fn(*mut GxrAction, c_float, c_float, c_float, c_float, u64) -> gboolean>,
...
impl ::std::fmt::Debug for GxrActionClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrActionClass @ {:p}", self))
         .field("parent", &self.parent)
         .field("poll", &self.poll)
         .field("trigger_haptic", &self.trigger_haptic)
         .field("set_digital_from_float_threshold", &self.set_digital_from_float_threshold)
         .field("set_digital_from_float_haptic", &self.set_digital_from_float_haptic)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrActionManifestEntry {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrActionManifestEntry @ {:p}", self))
...
pub struct GxrActionSetClass {
    ...
    pub create_action: Option<unsafe extern "C" fn(*mut GxrActionSet, *mut GxrContext, GxrActionType, *mut c_char) -> *mut GxrAction>,
    pub attach_bindings: Option<unsafe extern "C" fn(*mut *mut GxrActionSet, *mut GxrContext, u32) -> gboolean>,
}

impl ::std::fmt::Debug for GxrActionSetClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrActionSetClass @ {:p}", self))
         .field("parent", &self.parent)
...
impl ::std::fmt::Debug for GxrAnalogEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrAnalogEvent @ {:p}", self))
...
impl ::std::fmt::Debug for GxrBackendClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrBackendClass @ {:p}", self))
...
impl ::std::fmt::Debug for GxrBinding {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrBinding @ {:p}", self))
...
impl ::std::fmt::Debug for GxrBindingManifest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrBindingManifest @ {:p}", self))
...
impl ::std::fmt::Debug for GxrBindingPath {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrBindingPath @ {:p}", self))
...
pub struct GxrContextClass {
    pub parent: gobject::GObjectClass,
    pub get_frustum_angles: Option<unsafe extern "C" fn(*mut GxrContext, GxrEye, *mut c_float, *mut c_float, *mut c_float, *mut c_float)>,
    ...
    pub init_runtime: Option<unsafe extern "C" fn(*mut GxrContext, GxrAppType, *mut c_char, u32) -> gboolean>,
    ...
    pub load_action_manifest: Option<unsafe extern "C" fn(*mut GxrContext, *const c_char, *const c_char, *const c_char) -> gboolean>,
    pub request_quit: Option<unsafe extern "C" fn(*mut GxrContext)>,
    pub get_instance_extensions: Option<unsafe extern "C" fn(*mut GxrContext, *mut *mut glib::GSList) -> gboolean>,
    pub get_view_count: Option<unsafe extern "C" fn(*mut GxrContext) -> u32>,
}

impl ::std::fmt::Debug for GxrContextClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrContextClass @ {:p}", self))
         .field("parent", &self.parent)
         ...
         .field("is_tracked_device_connected", &self.is_tracked_device_connected)
...
impl ::std::fmt::Debug for GxrControllerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrControllerClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrDeviceClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrDeviceClass @ {:p}", self))
         .field("parent", &self.parent)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrDeviceManagerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrDeviceManagerClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrDigitalEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrDigitalEvent @ {:p}", self))
         .field("active", &self.active)
...
impl ::std::fmt::Debug for GxrGrabState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrGrabState @ {:p}", self))
...
impl ::std::fmt::Debug for GxrHoverState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrHoverState @ {:p}", self))
...
impl ::std::fmt::Debug for GxrManifestClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrManifestClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrModelInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrModelInterface @ {:p}", self))
         .field("parent", &self.parent)
...
pub struct GxrOverlayClass {
    ...
    pub set_mouse_scale: Option<unsafe extern "C" fn(*mut GxrOverlay, c_float, c_float) -> gboolean>,
...
impl ::std::fmt::Debug for GxrOverlayClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrOverlayClass @ {:p}", self))
         .field("parent", &self.parent)
         .field("poll_event", &self.poll_event)
...
impl ::std::fmt::Debug for GxrPointerData {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPointerData @ {:p}", self))
...
impl ::std::fmt::Debug for GxrPointerInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPointerInterface @ {:p}", self))
         .field("parent", &self.parent)
...
impl ::std::fmt::Debug for GxrPointerTipAnimation {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPointerTipAnimation @ {:p}", self))
         .field("tip", &self.tip)
...
impl ::std::fmt::Debug for GxrPointerTipData {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPointerTipData @ {:p}", self))
         .field("tip", &self.tip)
         .field("active", &self.active)
...
impl ::std::fmt::Debug for GxrPointerTipInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPointerTipInterface @ {:p}", self))
         .field("parent", &self.parent)
         .field("show", &self.show)
         .field("hide", &self.hide)
         .field("is_visible", &self.is_visible)
...
impl ::std::fmt::Debug for GxrPointerTipSettings {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPointerTipSettings @ {:p}", self))
...
impl ::std::fmt::Debug for GxrPose {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPose @ {:p}", self))
...
impl ::std::fmt::Debug for GxrPoseEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrPoseEvent @ {:p}", self))
         .field("active", &self.active)
...
impl ::std::fmt::Debug for GxrQuitEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrQuitEvent @ {:p}", self))
...
impl ::std::fmt::Debug for GxrAction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrAction @ {:p}", self))
...
impl ::std::fmt::Debug for GxrActionSet {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrActionSet @ {:p}", self))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrBackend {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrBackend @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrContext {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrContext @ {:p}", self))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrController {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrController @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrDevice {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrDevice @ {:p}", self))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrDeviceManager {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrDeviceManager @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrManifest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrManifest @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for GxrOverlay {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GxrOverlay @ {:p}", self))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn gxr_action_sets_attach_bindings(sets: *mut *mut GxrActionSet, context: *mut GxrContext, count: u32) -> gboolean;
    ...
    pub fn gxr_action_set_new_from_url(context: *mut GxrContext, url: *mut c_char) -> *mut GxrActionSet;
    pub fn gxr_action_set_connect(self_: *mut GxrActionSet, context: *mut GxrContext, type_: GxrActionType, url: *mut c_char, callback: gobject::GCallback, data: gpointer) -> gboolean;
    pub fn gxr_action_set_connect_digital_from_float(self_: *mut GxrActionSet, context: *mut GxrContext, url: *mut c_char, threshold: c_float, haptic_url: *mut c_char, callback: gobject::GCallback, data: gpointer) -> *mut GxrAction;
    ...
    pub fn gxr_context_new(type_: GxrAppType, app_name: *mut c_char, app_version: u32) -> *mut GxrContext;
    pub fn gxr_context_new_from_api(type_: GxrAppType, backend: GxrApi, app_name: *mut c_char, app_version: u32) -> *mut GxrContext;
    pub fn gxr_context_new_from_vulkan_extensions(type_: GxrAppType, instance_ext_list: *mut glib::GSList, device_ext_list: *mut glib::GSList, app_name: *mut c_char, app_version: u32) -> *mut GxrContext;
    pub fn gxr_context_new_full(type_: GxrAppType, api: GxrApi, instance_ext_list: *mut glib::GSList, device_ext_list: *mut glib::GSList, app_name: *mut c_char, app_version: u32) -> *mut GxrContext;
    pub fn gxr_context_new_headless(app_name: *mut c_char, app_version: u32) -> *mut GxrContext;
    pub fn gxr_context_new_headless_from_api(api: GxrApi, app_name: *mut c_char, app_version: u32) -> *mut GxrContext;
    ...
    pub fn gxr_context_load_action_manifest(self_: *mut GxrContext, cache_name: *const c_char, resource_path: *const c_char, manifest_name: *const c_char) -> gboolean;
    ...
    pub fn gxr_controller_new(controller_handle: u64, context: *mut GxrContext, model_name: *mut c_char) -> *mut GxrController;
    ...
    pub fn gxr_device_manager_add(self_: *mut GxrDeviceManager, context: *mut GxrContext, device_id: u64, is_controller: bool) -> gboolean;
    pub fn gxr_device_manager_connect_pose_actions(self_: *mut GxrDeviceManager, context: *mut GxrContext, action_set: *mut GxrActionSet, pointer_pose_url: *mut c_char, hand_grip_pose_url: *mut c_char);
    ...
    pub fn gxr_overlay_new_width(context: *mut GxrContext, key: *mut c_char, meters: c_float) -> *mut GxrOverlay;
    ...
    pub fn gxr_overlay_set_cairo_surface_raw(self_: *mut GxrOverlay, surface: *mut cairo::cairo_surface_t) -> gboolean;
    pub fn gxr_overlay_set_flip_y(self_: *mut GxrOverlay, flip_y: gboolean);
    pub fn gxr_overlay_set_gdk_pixbuf_raw(self_: *mut GxrOverlay, pixbuf: *mut gdk_pixbuf::GdkPixbuf) -> gboolean;
    pub fn gxr_overlay_set_mouse_scale(self_: *mut GxrOverlay, width: c_float, height: c_float) -> gboolean;
    pub fn gxr_overlay_set_raw(self_: *mut GxrOverlay, pixels: *mut u8, width: u32, height: u32, depth: u32) -> gboolean;
    ...
    pub fn gxr_pointer_tip_render(self_: *mut GxrPointerTip, progress: c_float) -> *mut gdk_pixbuf::GdkPixbuf;
    ...
    pub fn gxr_pointer_tip_update_apparent_size(self_: *mut GxrPointerTip, context: *mut GxrContext);
    pub fn gxr_pointer_tip_update_keep_apparent_size(self_: *mut GxrPointerTip, keep_apparent_size: gboolean);
    pub fn gxr_pointer_tip_update_pulse_alpha(self_: *mut GxrPointerTip, alpha: c_double);
    pub fn gxr_pointer_tip_update_texture_resolution(self_: *mut GxrPointerTip, width: c_int, height: c_int);
