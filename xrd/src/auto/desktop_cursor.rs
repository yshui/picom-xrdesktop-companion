...
impl<O: IsA<DesktopCursor>> DesktopCursorExt for O {
    ...
    fn texture(&self) -> Option<gulkan::Texture> {
        unsafe {
            from_glib_none(ffi::xrd_desktop_cursor_get_texture(self.as_ref().to_glib_none().0))
        }
    }

    fn transformation(&self, matrix: &mut graphene::Matrix) {
        unsafe {
            ffi::xrd_desktop_cursor_get_transformation(self.as_ref().to_glib_none().0, matrix.to_glib_none_mut().0);
        }
    }
    ...
    fn set_and_submit_texture(&self, texture: &gulkan::Texture) {
        unsafe {
            ffi::xrd_desktop_cursor_set_and_submit_texture(self.as_ref().to_glib_none().0, texture.to_glib_none().0);
        }
    }
    ...
    fn set_transformation(&self, matrix: &mut graphene::Matrix) {
        unsafe {
            ffi::xrd_desktop_cursor_set_transformation(self.as_ref().to_glib_none().0, matrix.to_glib_none_mut().0);
        }
    }
