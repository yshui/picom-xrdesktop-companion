...
pub fn math_clamp_towards_zero_2d(min: &mut graphene::Point, max: &mut graphene::Point, point: &mut graphene::Point, clamped: &mut graphene::Point) -> bool {
    unsafe {
        from_glib(ffi::xrd_math_clamp_towards_zero_2d(min.to_glib_none_mut().0, max.to_glib_none_mut().0, point.to_glib_none_mut().0, clamped.to_glib_none_mut().0))
    }
}
...
pub fn math_intersect_lines_2d(p0: &mut graphene::Point, p1: &mut graphene::Point, p2: &mut graphene::Point, p3: &mut graphene::Point, intersection: &mut graphene::Point) -> bool {
    unsafe {
        from_glib(ffi::xrd_math_intersect_lines_2d(p0.to_glib_none_mut().0, p1.to_glib_none_mut().0, p2.to_glib_none_mut().0, p3.to_glib_none_mut().0, intersection.to_glib_none_mut().0))
    }
}
