...
pub trait WindowExt: 'static {
    ...
    fn intersection_2d(&self, intersection_3d: &mut graphene::Point3D, intersection_2d: &mut graphene::Point);
    ...
    fn intersection_2d_pixels(&self, intersection_3d: &mut graphene::Point3D, intersection_pixels: &mut graphene::Point);
...
impl<O: IsA<Window>> WindowExt for O {
    fn add_child(&self, child: &impl IsA<Window>, offset_center: &mut graphene::Point) {
        unsafe {
            ffi::xrd_window_add_child(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, offset_center.to_glib_none_mut().0);
        }
    }
    ...
    fn intersection_2d(&self, intersection_3d: &mut graphene::Point3D, intersection_2d: &mut graphene::Point) {
        unsafe {
            ffi::xrd_window_get_intersection_2d(self.as_ref().to_glib_none().0, intersection_3d.to_glib_none_mut().0, intersection_2d.to_glib_none_mut().0);
        }
    }

    fn intersection_2d_pixels(&self, intersection_3d: &mut graphene::Point3D, intersection_pixels: &mut graphene::Point) {
        unsafe {
            ffi::xrd_window_get_intersection_2d_pixels(self.as_ref().to_glib_none().0, intersection_3d.to_glib_none_mut().0, intersection_pixels.to_glib_none_mut().0);
        }
    }
