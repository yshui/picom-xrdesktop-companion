...
pub trait WindowExt: 'static {
    ...
    //fn reset_transformation(&self, transform: /*Ignored*/&mut graphene::Matrix);
    ...
    //fn is_transformation(&self, mat: /*Ignored*/&mut graphene::Matrix) -> bool;

    //#[doc(alias = "xrd_window_get_transformation_no_scale")]
    //#[doc(alias = "get_transformation_no_scale")]
    //fn is_transformation_no_scale(&self, mat: /*Ignored*/&mut graphene::Matrix) -> bool;
    ...
    //fn set_reset_transformation(&self, transform: /*Ignored*/&mut graphene::Matrix);

    //#[doc(alias = "xrd_window_set_transformation")]
    //fn set_transformation(&self, mat: /*Ignored*/&mut graphene::Matrix) -> bool;
    ...
    fn connect_button_press_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "button-release-event")]
    fn connect_button_release_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "destroy")]
    fn connect_destroy<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "grab-event")]
    fn connect_grab_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "grab-start-event")]
    fn connect_grab_start_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "hover-end-event")]
    fn connect_hover_end_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "hover-event")]
    fn connect_hover_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "hover-start-event")]
    fn connect_hover_start_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "keyboard-close-event")]
    fn connect_keyboard_close_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;
    ...
    fn connect_motion_notify_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "release-event")]
    fn connect_release_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "scroll-event")]
    fn connect_scroll_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "show")]
    fn connect_show<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "initial-height-meters")]
    fn connect_initial_height_meters_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "initial-width-meters")]
    fn connect_initial_width_meters_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "native")]
    fn connect_native_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "scale")]
    fn connect_scale_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "texture-height")]
    fn connect_texture_height_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;

    #[doc(alias = "texture-width")]
    fn connect_texture_width_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId;
}
...
impl<O: IsA<Window>> WindowExt for O {
    ...
    //fn reset_transformation(&self, transform: /*Ignored*/&mut graphene::Matrix) {
    //    unsafe { TODO: call ffi:xrd_window_get_reset_transformation() }
    //}

    //fn texture(&self) -> /*Ignored*/Option<gulkan::Texture> {
    //    unsafe { TODO: call ffi:xrd_window_get_texture() }
    //}

    //fn is_transformation(&self, mat: /*Ignored*/&mut graphene::Matrix) -> bool {
    //    unsafe { TODO: call ffi:xrd_window_get_transformation() }
    //}

    //fn is_transformation_no_scale(&self, mat: /*Ignored*/&mut graphene::Matrix) -> bool {
    //    unsafe { TODO: call ffi:xrd_window_get_transformation_no_scale() }
    //}
    ...
    //fn set_and_submit_texture(&self, texture: /*Ignored*/&gulkan::Texture) {
    //    unsafe { TODO: call ffi:xrd_window_set_and_submit_texture() }
    //}
    ...
    //fn set_reset_transformation(&self, transform: /*Ignored*/&mut graphene::Matrix) {
    //    unsafe { TODO: call ffi:xrd_window_set_reset_transformation() }
    //}

    //fn set_transformation(&self, mat: /*Ignored*/&mut graphene::Matrix) -> bool {
    //    unsafe { TODO: call ffi:xrd_window_set_transformation() }
    //}
    ...
    fn connect_button_press_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn button_press_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
    ...
    fn connect_button_release_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn button_release_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_destroy<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn destroy_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    fn connect_grab_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn grab_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_grab_start_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn grab_start_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_hover_end_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn hover_end_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_hover_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn hover_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_hover_start_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn hover_start_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_keyboard_close_event<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn keyboard_close_event_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_keyboard_press_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn keyboard_press_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_motion_notify_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn motion_notify_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_release_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn release_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_scroll_event<F: Fn(&Self, &gdk::Event) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn scroll_event_trampoline<P: IsA<Window>, F: Fn(&P, &gdk::Event) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_none(object))
        }
        unsafe {
    ...
    fn connect_show<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_initial_height_meters_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_initial_height_meters_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_initial_width_meters_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_initial_width_meters_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_native_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_native_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_scale_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scale_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_texture_height_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_texture_height_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_texture_width_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_texture_width_trampoline<P: IsA<Window>, F: Fn(&P) + Send + Sync + 'static>(this: *mut ffi::XrdWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
