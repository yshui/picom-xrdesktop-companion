...
impl WindowManager {
    ...
    pub fn connect_no_hover_event<F: Fn(&Self, &gdk::Event) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn no_hover_event_trampoline<F: Fn(&WindowManager, &gdk::Event) + Send + 'static>(this: *mut ffi::XrdWindowManager, object: *mut gdk::ffi::GdkEvent, f: glib::ffi::gpointer) {
