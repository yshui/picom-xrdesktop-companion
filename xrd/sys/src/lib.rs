...
impl ::std::fmt::Debug for XrdClickEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdClickEvent @ {:p}", self))
...
pub struct XrdClientClass {
    ...
    pub add_button: Option<unsafe extern "C" fn(*mut XrdClient, *mut *mut XrdWindow, c_int, *mut *mut c_char, *mut graphene::graphene_point3d_t, gobject::GCallback, gpointer) -> gboolean>,
    ...
    pub window_new_from_meters: Option<unsafe extern "C" fn(*mut XrdClient, *const c_char, c_float, c_float, c_float) -> *mut XrdWindow>,
    pub window_new_from_data: Option<unsafe extern "C" fn(*mut XrdClient, *mut XrdWindowData) -> *mut XrdWindow>,
    pub window_new_from_pixels: Option<unsafe extern "C" fn(*mut XrdClient, *const c_char, u32, u32, c_float) -> *mut XrdWindow>,
    pub window_new_from_native: Option<unsafe extern "C" fn(*mut XrdClient, *const c_char, gpointer, u32, u32, c_float) -> *mut XrdWindow>,
}

impl ::std::fmt::Debug for XrdClientClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdClientClass @ {:p}", self))
...
impl ::std::fmt::Debug for XrdContainerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdContainerClass @ {:p}", self))
...
impl ::std::fmt::Debug for XrdDesktopCursorData {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdDesktopCursorData @ {:p}", self))
...
pub struct XrdDesktopCursorInterface {
    ...
    pub set_and_submit_texture: Option<unsafe extern "C" fn(*mut XrdDesktopCursor, *mut gulkan::GulkanTexture)>,
    pub get_texture: Option<unsafe extern "C" fn(*mut XrdDesktopCursor) -> *mut gulkan::GulkanTexture>,
    ...
    pub get_transformation: Option<unsafe extern "C" fn(*mut XrdDesktopCursor, *mut graphene::graphene_matrix_t)>,
    pub set_transformation: Option<unsafe extern "C" fn(*mut XrdDesktopCursor, *mut graphene::graphene_matrix_t)>,
}

impl ::std::fmt::Debug for XrdDesktopCursorInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdDesktopCursorInterface @ {:p}", self))
         .field("parent", &self.parent)
...
impl ::std::fmt::Debug for XrdGrabEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdGrabEvent @ {:p}", self))
...
impl ::std::fmt::Debug for XrdHoverEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdHoverEvent @ {:p}", self))
...
impl ::std::fmt::Debug for XrdInputSynthClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdInputSynthClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdMoveCursorEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdMoveCursorEvent @ {:p}", self))
         .field("window", &self.window)
         .field("position", &self.position)
...
impl ::std::fmt::Debug for XrdNoHoverEvent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdNoHoverEvent @ {:p}", self))
         .field("controller", &self.controller)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdShakeCompensatorClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdShakeCompensatorClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdTransformTransition {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdTransformTransition @ {:p}", self))
         .field("window", &self.window)
...
impl ::std::fmt::Debug for XrdWindowData {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdWindowData @ {:p}", self))
...
pub struct XrdWindowInterface {
    pub parent: gobject::GTypeInterface,
    pub set_transformation: Option<unsafe extern "C" fn(*mut XrdWindow, *mut graphene::graphene_matrix_t) -> gboolean>,
    pub get_transformation: Option<unsafe extern "C" fn(*mut XrdWindow, *mut graphene::graphene_matrix_t) -> gboolean>,
    pub get_transformation_no_scale: Option<unsafe extern "C" fn(*mut XrdWindow, *mut graphene::graphene_matrix_t) -> gboolean>,
    pub submit_texture: Option<unsafe extern "C" fn(*mut XrdWindow)>,
    pub set_and_submit_texture: Option<unsafe extern "C" fn(*mut XrdWindow, *mut gulkan::GulkanTexture)>,
    ...
    pub add_child: Option<unsafe extern "C" fn(*mut XrdWindow, *mut XrdWindow, *mut graphene::graphene_point_t)>,
...
impl ::std::fmt::Debug for XrdWindowInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdWindowInterface @ {:p}", self))
         .field("parent", &self.parent)
         .field("set_transformation", &self.set_transformation)
         .field("get_transformation", &self.get_transformation)
         .field("get_transformation_no_scale", &self.get_transformation_no_scale)
         .field("submit_texture", &self.submit_texture)
         .field("set_and_submit_texture", &self.set_and_submit_texture)
         .field("get_texture", &self.get_texture)
...
impl ::std::fmt::Debug for XrdWindowManagerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdWindowManagerClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdClient {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdClient @ {:p}", self))
...
impl ::std::fmt::Debug for XrdContainer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdContainer @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdInputSynth {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdInputSynth @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdShakeCompensator {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdShakeCompensator @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdWindowManager {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XrdWindowManager @ {:p}", self))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XrdDesktopCursor {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "XrdDesktopCursor @ {:p}", self)
    }
}
...
extern "C" {
    ...
    pub fn xrd_client_add_button(self_: *mut XrdClient, button: *mut XrdWindow, position: *mut graphene::graphene_point3d_t, press_callback: gobject::GCallback, press_callback_data: gpointer);
    pub fn xrd_client_add_container(self_: *mut XrdClient, container: *mut XrdContainer);
    pub fn xrd_client_add_window(self_: *mut XrdClient, window: *mut XrdWindow, draggable: gboolean, lookup_key: gpointer);
    pub fn xrd_client_button_new_from_icon(self_: *mut XrdClient, width: c_float, height: c_float, ppm: c_float, url: *const c_char) -> *mut XrdWindow;
    pub fn xrd_client_button_new_from_text(self_: *mut XrdClient, width: c_float, height: c_float, ppm: c_float, label_count: c_int, label: *mut *mut c_char) -> *mut XrdWindow;
    ...
    pub fn xrd_container_add_window(self_: *mut XrdContainer, window: *mut XrdWindow, relative_transform: *mut graphene::graphene_matrix_t);
    pub fn xrd_container_center_view(self_: *mut XrdContainer, context: *mut gxr::GxrContext, distance: c_float);
    ...
    pub fn xrd_container_set_attachment(self_: *mut XrdContainer, attachment: XrdContainerAttachment, controller: *mut gxr::GxrController);
    ...
    pub fn xrd_input_synth_create_action_set(self_: *mut XrdInputSynth, context: *mut gxr::GxrContext) -> *mut gxr::GxrActionSet;
    pub fn xrd_input_synth_get_primary_controller(self_: *mut XrdInputSynth) -> *mut gxr::GxrController;
    pub fn xrd_input_synth_make_primary(self_: *mut XrdInputSynth, controller: *mut gxr::GxrController);
    ...
    pub fn xrd_window_manager_add_container(self_: *mut XrdWindowManager, container: *mut XrdContainer);
    pub fn xrd_window_manager_add_window(self_: *mut XrdWindowManager, window: *mut XrdWindow, flags: XrdWindowFlags);
    pub fn xrd_window_manager_arrange_reset(self_: *mut XrdWindowManager);
    pub fn xrd_window_manager_arrange_sphere(self_: *mut XrdWindowManager, context: *mut gxr::GxrContext) -> gboolean;
    pub fn xrd_window_manager_check_grab(self_: *mut XrdWindowManager, controller: *mut gxr::GxrController);
    pub fn xrd_window_manager_check_release(self_: *mut XrdWindowManager, controller: *mut gxr::GxrController);
    pub fn xrd_window_manager_drag_start(self_: *mut XrdWindowManager, controller: *mut gxr::GxrController);
    ...
    pub fn xrd_window_manager_poll_window_events(self_: *mut XrdWindowManager, context: *mut gxr::GxrContext);
    pub fn xrd_window_manager_remove_container(self_: *mut XrdWindowManager, container: *mut XrdContainer);
    pub fn xrd_window_manager_remove_window(self_: *mut XrdWindowManager, window: *mut XrdWindow);
    pub fn xrd_window_manager_scale(self_: *mut XrdWindowManager, grab_state: *mut gxr::GxrGrabState, factor: c_float, update_rate_ms: c_float);
    pub fn xrd_window_manager_set_hover_mode(self_: *mut XrdWindowManager, mode: XrdHoverMode);
    pub fn xrd_window_manager_update_controller(self_: *mut XrdWindowManager, controller: *mut gxr::GxrController);
    ...
    pub fn xrd_desktop_cursor_get_texture(self_: *mut XrdDesktopCursor) -> *mut gulkan::GulkanTexture;
    pub fn xrd_desktop_cursor_get_transformation(self_: *mut XrdDesktopCursor, matrix: *mut graphene::graphene_matrix_t);
    ...
    pub fn xrd_desktop_cursor_set_and_submit_texture(self_: *mut XrdDesktopCursor, texture: *mut gulkan::GulkanTexture);
    pub fn xrd_desktop_cursor_set_hotspot(self_: *mut XrdDesktopCursor, hotspot_x: c_int, hotspot_y: c_int);
    pub fn xrd_desktop_cursor_set_transformation(self_: *mut XrdDesktopCursor, matrix: *mut graphene::graphene_matrix_t);
    ...
    pub fn xrd_desktop_cursor_update(self_: *mut XrdDesktopCursor, context: *mut gxr::GxrContext, window: *mut XrdWindow, intersection: *mut graphene::graphene_point3d_t);

    //=========================================================================
    // XrdWindow
    //=========================================================================
    pub fn xrd_window_get_type() -> GType;
    pub fn xrd_window_new_from_data(self_: *mut XrdClient, data: *mut XrdWindowData) -> *mut XrdWindow;
    pub fn xrd_window_new_from_meters(client: *mut XrdClient, title: *const c_char, width: c_float, height: c_float, ppm: c_float) -> *mut XrdWindow;
    pub fn xrd_window_new_from_native(client: *mut XrdClient, title: *const c_char, native: gpointer, width_pixels: u32, height_pixels: u32, ppm: c_float) -> *mut XrdWindow;
    pub fn xrd_window_new_from_pixels(client: *mut XrdClient, title: *const c_char, width: u32, height: u32, ppm: c_float) -> *mut XrdWindow;
    pub fn xrd_window_add_child(self_: *mut XrdWindow, child: *mut XrdWindow, offset_center: *mut graphene::graphene_point_t);
    ...
    pub fn xrd_window_get_intersection_2d(self_: *mut XrdWindow, intersection_3d: *mut graphene::graphene_point3d_t, intersection_2d: *mut graphene::graphene_point_t);
    pub fn xrd_window_get_intersection_2d_pixels(self_: *mut XrdWindow, intersection_3d: *mut graphene::graphene_point3d_t, intersection_pixels: *mut graphene::graphene_point_t);
    ...
    pub fn xrd_window_get_reset_transformation(self_: *mut XrdWindow, transform: *mut graphene::graphene_matrix_t);
    pub fn xrd_window_get_texture(self_: *mut XrdWindow) -> *mut gulkan::GulkanTexture;
    pub fn xrd_window_get_transformation(self_: *mut XrdWindow, mat: *mut graphene::graphene_matrix_t) -> gboolean;
    pub fn xrd_window_get_transformation_no_scale(self_: *mut XrdWindow, mat: *mut graphene::graphene_matrix_t) -> gboolean;
    ...
    pub fn xrd_window_set_and_submit_texture(self_: *mut XrdWindow, texture: *mut gulkan::GulkanTexture);
    ...
    pub fn xrd_window_set_reset_transformation(self_: *mut XrdWindow, transform: *mut graphene::graphene_matrix_t);
    pub fn xrd_window_set_transformation(self_: *mut XrdWindow, mat: *mut graphene::graphene_matrix_t) -> gboolean;
    ...
    // Other functions
    //=========================================================================
    pub fn xrd_button_set_icon(button: *mut XrdWindow, client: *mut gulkan::GulkanClient, upload_layout: u32, url: *const c_char);
    pub fn xrd_button_set_text(button: *mut XrdWindow, client: *mut gulkan::GulkanClient, upload_layout: u32, label_count: c_int, label: *mut *mut c_char);
    pub fn xrd_math_clamp_towards_zero_2d(min: *mut graphene::graphene_point_t, max: *mut graphene::graphene_point_t, point: *mut graphene::graphene_point_t, clamped: *mut graphene::graphene_point_t) -> gboolean;
    pub fn xrd_math_get_rotation_angles(direction: *mut graphene::graphene_vec3_t, azimuth: *mut c_float, inclination: *mut c_float);
    pub fn xrd_math_intersect_lines_2d(p0: *mut graphene::graphene_point_t, p1: *mut graphene::graphene_point_t, p2: *mut graphene::graphene_point_t, p3: *mut graphene::graphene_point_t, intersection: *mut graphene::graphene_point_t) -> gboolean;
    pub fn xrd_math_matrix_set_translation_point(matrix: *mut graphene::graphene_matrix_t, point: *mut graphene::graphene_point3d_t);
    pub fn xrd_math_matrix_set_translation_vec(matrix: *mut graphene::graphene_matrix_t, vec: *mut graphene::graphene_vec3_t);
    pub fn xrd_math_point_matrix_distance(intersection_point: *mut graphene::graphene_point3d_t, pose: *mut graphene::graphene_matrix_t) -> c_float;
    pub fn xrd_math_sphere_to_3d_coords(azimuth: c_float, inclination: c_float, distance: c_float, point: *mut graphene::graphene_point3d_t);
    pub fn xrd_render_lock();
    pub fn xrd_render_lock_destroy();
    pub fn xrd_render_lock_init();
    pub fn xrd_render_unlock();
    pub fn xrd_settings_connect_and_apply(callback: gobject::GCallback, key: *mut c_char, data: gpointer);
    ...
    pub fn xrd_settings_update_double_val(settings: *mut gio::GSettings, key: *mut c_char, val: *mut c_double);
    pub fn xrd_settings_update_gboolean_val(settings: *mut gio::GSettings, key: *mut c_char, val: *mut gboolean);
    pub fn xrd_settings_update_int_val(settings: *mut gio::GSettings, key: *mut c_char, val: *mut c_int);
